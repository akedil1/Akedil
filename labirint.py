...
class Player(GameSprite):
    def __init__(self, player_image,player_x,player_y,size_x,size_y,player_x_speed,palyer_y_speed):
        GameSprite.__init__(self, player_image,player_x,player_y,size_x,size_y)


        self.x_speed = player_x_speed
        self.y_speed = palyer_y_speed
    def update(self):
...
w1 = GameSprite('platform2.png',win_width/2-win_width/3,win_height/3,300,50)
